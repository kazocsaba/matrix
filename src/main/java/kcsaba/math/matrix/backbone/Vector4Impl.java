...
/**
 * A {@link MatrixData}-backed {@code Vector4} implementation.
 * <p>
 * This class is intended for subclassing to help the creation of implementations using specific {@code MatrixData}.
 * @author Kazó Csaba
 */
public class Vector4Impl extends VectorImpl<Vector4> implements Vector4 {
	 ...
	 */
	public Vector4Impl(MatrixData data) {
		super(data);
	}
